...
from PyQt6.QtCore import Qt, QThreadPool, pyqtSignal, QObject, QCoreApplication, QThread
...
class AntivirusApp(QMainWindow):
    ...
    def _show_about_dialog(self):
        ...
        if self.icon_path:
            msg_box.setIconPixmap(QPixmap(self.icon_path).scaled(64, 64, Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation))
        msg_box.exec()
    ...
    def _show_language_dialog(self):
        ...
        dialog = QInputDialog()
        selected_display_name, ok = QInputDialog.getItem(self, 
    ...
    def _create_left_panel(self):
        ...
        if self.icon_path:
            icon_pixmap = QPixmap(self.icon_path).scaled(64, 64, Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation) 
            icon_label = QLabel()
            icon_label.setPixmap(icon_pixmap)
            title_layout.addWidget(icon_label)
        
        self.logo_label = QLabel(LANG.get_string("App", "title")) 
        self.logo_label.setFont(QFont("SansSerif", 14, QFont.Weight.Bold)) 
        ...
        self.start_button.setFont(QFont("SansSerif", 12, QFont.Weight.Bold))
    ...
    def _create_right_panel(self):
        ...
        self.result_title.setFont(QFont("SansSerif", 10, QFont.Weight.Bold)) 
    ...
    def _create_action_buttons(self):
        ...
        self.delete_button.setFont(QFont("SansSerif", 10, QFont.Weight.Bold))
    ...
    def _add_scan_result(self, result):
        ...
        item.setData(1, Qt.ItemDataRole.UserRole, result["risk_key"])
        ...
        for item in self._iter_items(root):
            ...
            if checkbox_widget:
                ...
                if checkbox:
                    ...
                    item_risk = item.data(1, Qt.ItemDataRole.UserRole)
